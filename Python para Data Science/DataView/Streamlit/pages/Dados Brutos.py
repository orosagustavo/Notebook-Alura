...
#----------------------------------------------------------------
#Funções
@st.cache_data #Armazenar no cache caso o df não seja alterado e não precisa converter sempre
def converte_csv(df):
...
with coluna2:
    st.download_button('Fazer Download da tabela em csv', converte_csv(dados_filtrados), file_name = nome_arquivo, mime = 'text/csv', on_click = mensagem_sucesso)
